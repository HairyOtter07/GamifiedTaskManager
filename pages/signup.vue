<template>
  <div>
    ...
    <div class="flex h-full w-full max-w-7xl flex-col items-center justify-center space-y-6 font-mono">
      ...
      <div>
        <p :class="usernameError ? 'text-red-600' : ''">
          Username
        </p>
        <input v-model="username" class="border-4 bg-transparent px-6 py-3" :class="usernameError ? 'border-red-600 text-red-600' : 'border-white'">
      </div>
      <div>
